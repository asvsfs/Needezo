	...
	render(){
		...
		return (
				<div ref="div" className="itemBox" style={{/*position:'absolute',marginTop:this.props.marginTop,marginLeft:this.props.marginLeft,width:'385px',maxHeight:'305',*/}}>
				    ...
				    marginTop: '10px',
   					marginRight: '5px'}}>
   						<span style={{display:'block'}}>{this.props.data.date}</span>
					...
					<div className="itemFooter">
					    ...
					    marginTop: '10px',
	   					marginLeft: '5px'}}>{this.props.data.price}</span>
							...
							float:'right',
					    marginTop: '10px',
	   					marginRight: '5px'}}>{this.props.data.price}{/*<a style={{textDecoration:'none'}} href="#" onClick={self.gotIt.bind(self)}>Got It!</a>*/}</span>
					</div>
				</div>			
			);
	}
